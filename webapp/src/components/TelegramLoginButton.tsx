...
export function TelegramLoginButton() {
  ...
  // CRÍTICO: Renderizar DynamicWidget inmediatamente sin condiciones
  // Esto evita el parpadeo y los re-renders infinitos
  // El DynamicWidget maneja el flujo de autenticación automáticamente
